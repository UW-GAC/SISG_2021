...
We make the usual QQ plot, filtering to variants with minor allele count (MAC) >= 5. Notice that we observe much less inflation than before, when we did not adjust for ancestry and relatedness.
