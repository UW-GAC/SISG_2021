...
- **Zoom session 11:30-13:15 PDT** - Introduction and Genomic Data Storage
    - **Lecture**
        ...
        - Sequencing data formats ([slides](https://drive.google.com/file/d/1w_dEobxo6kzloQlIuHW_lUnwkPCYK-RP/view?usp=sharing)) ([pre-recorded lecture](https://washington.zoom.us/rec/share/CQBVagbRwvPsP3qn605dQZQWK7oTccn9zdgW5eFGhytDjaF2Hy-ugYWp6xOpBqRo.cF1_c5gy-k5DAoMI?startTime=1626201510000))
...
- **Zoom session 8:00-9:45 PDT** - Association tests, Part I
    - **Lecture**
        - Association tests: Methods and motivation  ([slides](https://drive.google.com/file/d/1caziaZ_tp0Brg_Atq0keiImSWx_GujXL/view?usp=sharing)) (video coming soon)
...
- **Zoom session 10:15-11:45 PDT** - Association tests, Part II
    - **Lecture**
        - Multiple variant association tests ([slides](https://drive.google.com/file/d/1XRcn9_Q0akqQkgKAD8DO_Cg4Nlk990gx/view?usp=sharing)) (video coming soon)
    - **Interactive breakout rooms**
