...
description: "Course materials for SISG Module 16"
---
...
This site contains course materials for Course materials for SISG Module 16: Computational Pipeline for WGS Data, July 21-23, 2021.
Data used is located in the [github repository](https://github.com/UW-GAC/SISG_2021) from which the site is built, as well as in the [TOPMed analysis pipeline](https://github.com/UW-GAC/analysis_pipeline).
...
- **Zoom session 11:30-13:15 PDT** - Introduction and Genomic Data Storage
    ...
    - Exercises in breakout rooms - [GDS format in R](https://uw-gac.github.io/SISG_2021/gds-format.html)
...
- **Zoom session 13:45-14:30 PDT** - Phenotype harmonization
    ...
    - Exercises in breakout rooms - [Harmonization in R](https://uw-gac.github.io/SISG_2021/phenotype-harmonization.html)
...
- **Zoom session 8:00-9:45 PDT** - Association tests, Part I
    ...
    - Exercises in breakout rooms - [Association tests in R](https://uw-gac.github.io/SISG_2021/association-tests.html)
...
- **Zoom session 10:15-11:45 PDT** - Association tests, Part II
    ...
    - Exercises in breakout rooms - [Sliding window tests](https://uw-gac.github.io/SISG_2021/association-tests.html#sliding-window-tests)
...
- **Zoom session 12:45-14:30 PDT** - Population Structure and Relatedness
    ...
    - Exercises in breakout rooms - [Population structure and relatedness in R](https://uw-gac.github.io/SISG_2021/computing-a-grm.html)
...
- **Zoom session 8:00-9:30 PDT** - Mixed models
    ...
    - Exercises in breakout rooms - [Mixed models in R](https://uw-gac.github.io/SISG_2021/mixed-models.html)
...
- **Zoom session 9:45-11:30 PDT** - Variant annotation
    ...
    - Exercises in breakout rooms - [Using variant annotation](https://uw-gac.github.io/SISG_2021/variant-annotation.html)
...
- **Zoom session 12:30-13:45 PDT** - Working in the cloud
    ...
    - Exercises in breakout rooms - [Running a GWAS workflow](https://uw-gac.github.io/SISG_2021/exercises-running-a-gwas-workflow.html)
