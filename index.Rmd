...
- **Zoom session 12:45-14:30 PDT** - Population Structure and Relatedness
    - **Lecture**
        ...
        - R packages for PCA and relatedness  ([slides](https://drive.google.com/file/d/1RMHcoe3lrK02tZ2Vy_B7XQEZChSlgpTh/view?usp=sharing)) (video coming soon)
    - **Interactive breakout rooms**
...
- **Zoom session 9:45-11:30 PDT** - Variant annotation
    ...
    - **Interactive breakout rooms**
        - Using variant annotation ([Tutorial](https://uw-gac.github.io/SISG_2021/variant-annotation.html)) ([Exercise]()) ([Solution]())
        - Discussion (video coming soon)
